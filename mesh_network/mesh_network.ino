...
// Define the MAC addresses as byte arrays
const uint8_t macAddress1[6] = {0x48, 0xe7, 0x29, 0x3f, 0x3b, 0x78};
const uint8_t macAddress2[6] = {0xe8, 0x68, 0xe7, 0x30, 0x5d, 0xa8};

if (current_peer_count < ESPNOW_PEER_COUNT &&
    (memcmp(info->src_addr, macAddress1, 6) == 0 || 
     memcmp(info->src_addr, macAddress2, 6) == 0)) {
...
void setup() {
  ...
  strncpy(new_msg.str, "Tracy!", sizeof(new_msg.str));
