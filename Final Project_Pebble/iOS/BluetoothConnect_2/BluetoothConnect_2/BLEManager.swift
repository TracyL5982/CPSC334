...
class BLEManager: NSObject, ObservableObject, CBCentralManagerDelegate, CBPeripheralDelegate, PebbleAPIDelegate {
    ...
    private let targetDeviceName = "ESP32_MissYouDevice1"
    private let serviceUUIDString = "12345678-1234-5678-1234-56789abcdef0"
    private let buttonCharUUIDString = "abcdef12-3456-789a-bcde-f0123456789a"
    private let vibratorCharUUIDString = "abcdef34-5678-90ab-cdef-123456789abc"
    ...
    // Set your deviceId in PebbleAPI init.
    // For Device A:
    // DeviceId = "my-device-A"
    // partnerId must match the deviceId of the other device.
    // For Device A's code:
    // partnerId = "my-device-B"
    private let myDeviceId = "my-device-B"     // This device's ID
    private let partnerId = "my-device-A"       // The other device's ID
